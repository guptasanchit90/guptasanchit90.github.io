  ...
  c.LIRenderAll = function () {
    function t(a) {
      return Array.prototype.slice
        ...
        .map(function (a) {
          return (
            encodeURIComponent(
              a.name.replace("data-", "").toLowerCase()
            ) +
            "\x3d" +
    ...
    function u(a) {
      var d = a.getAttribute("data-size"),
        ...
        f = a.hasAttribute("data-ei"),
        l = a.getAttribute("data-entity"),
        m = a.hasAttribute("data-iscreate"),
        n = a.hasAttribute("data-glimmer"),
        k = Math.round(1e6 * Math.random());
      f = f ? "https://badges.linkedin-ei" : "https://badges.linkedin";
      f =
        "undefined" !== typeof c &&
        /linkedin(-ei)?.cn$/.test(
          (c.location && c.location.hostname) || ""
        )
          ? f + ".cn/"
          : f + ".com/";
      b = [
      ...
      n && b.push("lrorbadger.guesthouse.glimmer\x3denabled");
      d = f + "?" + b.join("\x26");
    ...
    for (l = h.length; g < l; g++)
      (m = h[g]),
        ...
        s || (k++, m.setAttribute("data-rendered", !0), u(m));
